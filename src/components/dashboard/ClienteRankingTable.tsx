    ...
    <div className="bi-card">
      ...
      <div className="overflow-x-auto max-h-[400px] overflow-y-auto">
        <Table>
          ...
          <TableBody>
            {sorted.map((c, i) => (
              <TableRow key={c.nome_cliente} className="border-slate-800/50">
                ...
                <TableCell className="text-xs text-right text-slate-300">{c.quantidade_compras}</TableCell>
                <TableCell className="text-xs text-right text-cyan-400">{formatCurrency(c.ticket_medio)}</TableCell>
                <TableCell>
